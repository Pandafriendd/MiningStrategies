...
public interface Miner {
    /**
     * @return the Block that the miner is currently extending. 
     * May not yet have been published.
     */
     ...
     *
     * @return The block that the miner views as the current head of the chain. 
     * Could be an old block or a newly announced block or the head of a chain of newly announced blocks.
     */
    Block currentHead();
